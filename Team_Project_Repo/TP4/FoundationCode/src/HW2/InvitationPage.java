...
public class InvitationPage {
    ...
    public void show(DatabaseHelper databaseHelper, Stage primaryStage) {
        VBox layout = new VBox(10); // Increased spacing between elements
        layout.setStyle("-fx-alignment: center; -fx-padding: 20;");
        
        // Label to display the title of the page
        Label userLabel = new Label("Invitation Code Generator");
        ...
        backButton.setOnAction(e -> {
            ...
            new AdminHomePage(databaseHelper, "admin").show(primaryStage);
        });

        // Spacer between code section and back button
        Region spacer = new Region();
        spacer.setPrefHeight(20);

        layout.getChildren().addAll(userLabel, showCodeButton, inviteCodeLabel, spacer, backButton);
