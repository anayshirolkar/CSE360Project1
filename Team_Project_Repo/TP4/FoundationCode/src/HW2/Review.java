...
public class Review {
    ...
    private String originalReviewId; // ID of the original review this is updating
    ...
    /**
     * Sets the original review ID that this review is updating
     * @param originalReviewId The ID of the original review
     */
    public void setOriginalReviewId(String originalReviewId) {
